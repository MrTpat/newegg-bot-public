...
class NeweggCommunicator:
    ...
    def gen_session_id(
        self, p_id: str, s_id: str, is_combo: bool, **kwargs
    ) -> Optional[str]:
        def gen_data() -> dict:
            data = {
                "SaleType": 1,
            ...
            return {
                "ItemList": [
                    {"ItemNumber": s_id, "ItemKey": encryptedBytes, "Quantity": 1}
                ],
                "Actions": [],
            }
        ...
        headers = self.get_default_headers(
            {
                ...
                "referer": f"https://secure.newegg.com/shop/checkout?sessionId={session_id}",
            }
        )
        data = {
    ...
    def validate_address(
        ...
        **kwargs,
        ...
        data = {
            "TransNumber": transaction_number,
            "AddressLabel": "Untitled",
            "ContactWith": name,
            "Phone": phone,
            "Fax": "",
            "Country": country,
            ...
            "IsSelected": False,
            "SaveAddress": False,
            "QASDisplayLines": [address, f"{city}, {state} {zip_code}", country_long],
        }
        try:
            req = requests.post(
                url,
