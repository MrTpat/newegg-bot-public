...
class BillingProfile:
    ...
    def from_dict(d: dict):
        try:
            ...
            BillingProfile.logger.handle_err(e)
...
class ProductProfile:
    ...
    def from_dict(d: dict):
        try:
            ...
            ProductProfile.logger.handle_err(e)
...
class SettingsProfile:
    logger = Logger("[Settings profile] ")
    ...
    def __init__(
        ...
        validate_address_limit: int,
        cookie_file: str,
        submit_order_limit: int,
    ) -> None:
    ...
    def from_dict(d: dict):
        try:
            ...
            SettingsProfile.logger.handle_err(e)
